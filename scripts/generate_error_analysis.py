...
from ai_safety_eval_triage.reports import render_error_analysis


def main() -> None:
    taxonomy_version, cases = load_eval_cases("fixtures/eval_cases.json")
    report = render_error_analysis(run_triage(cases, taxonomy_version))
    path = Path("docs/error_analysis.md")
